...
//	Ð´Ð¾Ð±Ð°Ð²Ð»ÐµÐ½Ð° ÑÐµÑ€Ð²ÐµÑ€Ð½Ð°Ñ ÐºÐ»Ð°ÑÑ‚ÐµÑ€Ð¸Ð·Ð°Ñ†Ð¸Ñ. ÐžÐ½Ð° Ð²ÐºÐ»ÑŽÑ‡ÐµÐ½Ð° Ð¿Ð¾ ÑƒÐ¼Ð¾Ð»Ñ‡Ð°Ð½Ð¸ÑŽ Ð´Ð»Ñ ÐºÐ»Ð°ÑÑÐ° 
//	OpenLayers.Layer.Vector.OWMWeather
//	Ð´Ð»Ñ ÐºÐ»Ð°ÑÑÐ° OpenLayers.Layer.Vector.OWMStations Ð² Ð½Ð°ÑÑ‚Ð¾ÑÑ‰Ð¸Ð¹ Ð¼Ð¾Ð¼ÐµÐ½Ñ‚ ÑÐµÑ€Ð²ÐµÑ€Ð½Ð°Ñ ÐºÐ»Ð°ÑÑ‚ÐµÑ€Ð¸Ð·Ð°Ñ†Ð¸Ñ Ð½Ðµ Ñ€Ð°Ð±Ð¾Ñ‚Ð°ÐµÑ‚
//
//	2012.05.10 Version 1.1
//	Ð´Ð¾Ð±Ð°Ð²Ð»ÐµÐ½Ð° ÐºÐ»Ð¸ÐµÐ½Ñ‚ÑÐºÐ°Ñ ÐºÐ»Ð°ÑÑ‚ÐµÑ€Ð¸Ð·Ð°Ñ†Ð¸Ñ
...
// ÐšÐ¾Ð¼Ð¿Ð¾Ð·Ð¸Ñ‚Ð½Ñ‹Ð¹ ÑÐ»Ð¾Ð¹ tiles
...
OpenLayers.Layer.Vector.OWMWeather = OpenLayers.Class( OpenLayers.Layer.Vector, {
	...
	initialize:function(name,options)
	{
		...
		this.protocol = new OpenLayers.Protocol.Script({
				...
				format: 'json',
				units: this.units,
				layer: this		// Ð¸Ð´Ð¸Ð¾Ñ‚ÑÐºÐ¾Ðµ Ñ€ÐµÑˆÐµÐ½Ð¸Ðµ, Ð½Ð¾ Ñ Ð½Ðµ Ð¿Ð¾Ð½ÑÐ» ÐºÐ°Ðº Ð¸Ð½Ð°Ñ‡Ðµ Ð´Ð¾ÑÑ‚Ð°Ñ‚ÑŒ OpenLayers.Layer.Vector
                        },
                        filterToParams: function(filter, params) {
				if (filter.type === OpenLayers.Filter.Spatial.BBOX) {
					params.bbox = filter.value.toArray();
					params.bbox.push(params.layer.map.getZoom());	//Ð¼Ð°Ð³Ð¸Ñ - Ð´Ð¾Ð±Ð°Ð²Ð»ÑÑŽ zoom Ð² Ð¿Ð°Ñ€Ð°Ð¼ÐµÑ‚Ñ€Ñ‹
...
var WeekDayText = {
months: ["ÑÐ½Ð²Ð°Ñ€Ñ", "Ñ„ÐµÐ²Ñ€Ð°Ð»Ñ", "Ð¼Ð°Ñ€Ñ‚Ð°", "Ð°Ð¿Ñ€ÐµÐ»Ñ", "Ð¼Ð°Ñ", "Ð¸ÑŽÐ½Ñ", "Ð¸ÑŽÐ»Ñ", "Ð°Ð²Ð³ÑƒÑÑ‚Ð°", "ÑÐµÐ½Ñ‚ÑÐ±Ñ€Ñ", "Ð¾ÐºÑ‚ÑÐ±Ñ€Ñ", "Ð½Ð¾ÑÐ±Ñ€Ñ", "Ð´ÐµÐºÐ°Ð±Ñ€Ñ"],
days: ["Ð²Ð¾ÑÐºÑ€ÐµÑÐµÐ½ÑŒÐµ", "Ð¿Ð¾Ð½ÐµÐ´ÐµÐ»ÑŒÐ½Ð¸Ðº", "Ð²Ñ‚Ð¾Ñ€Ð½Ð¸Ðº", "ÑÑ€ÐµÐ´Ð°", "Ñ‡ÐµÑ‚Ð²ÐµÑ€Ð³", "Ð¿ÑÑ‚Ð½Ð¸Ñ†Ð°", "ÑÑƒÐ±Ð±Ð¾Ñ‚Ð°"],
//days_small: ["Ð²Ñ", "Ð¿Ð½", "Ð²Ñ‚", "ÑÑ€", "Ñ‡Ñ‚", "Ð¿Ñ‚", "ÑÐ±"]
...
function GetWeatherText2(st)
{
	...
	if( st.snow && st.snow['3h'] )
		txt = 'Snow ' + '( ' + st.snow['3h'] +'Ð¼Ð¼ )'; 

	if( st.rain && st.rain['3h'] )
		txt = 'Rain:' + '(' + st.rain['3h'] +'Ð¼Ð¼)'; 
	return txt;
}
...
<div class="weather_block">\
 <div class="cur_weather_block" title="'+wtext+'">\
  ...
  <div class="temp_block" >\
   <div class="big_temp" title="Current Temperature '+dt+'">'+temp+'Â°</div>\
   <div class="small_temp_block" >\
    <div class="small_temp">'+wtext+'</div>\
   </div>\
  </div>\
 </div>\
 <div class="small_val_grey" title="Min and max temperature">Min t: '+temp_min+' / Max t: '+temp_max+' Â°</div>\
...
'<div style="font-size: small; float: left; text-align: center;" >\
 ...
 <div class="small_val" title="Temperature">'+temp+'Â°</div>\
 <div class="small_val" title="Ð’ÐµÑ‚ÐµÑ€">'+forecast[i].wind.speed+' m/s</div>\
 <div class="small_val_grey" title="Ð”Ð°Ð²Ð»ÐµÐ½Ð¸Ðµ">'+forecast[i].main.pressure+'</div>\
</div>'
...
<div class="weather_block">\
 <div class="cur_weather_block" title="'+wdescription+'">\
  ...
  <div class="temp_block" >\
   <div class="big_temp" title="Current Temperature">'+temp+'Â°</div>\
   <div class="small_temp_block" >\
    <div class="small_temp">'+wtext+'</div>\
   </div>\
  </div>\
